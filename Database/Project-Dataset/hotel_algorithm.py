...
# print("1 Jaipur\n2 Udaipur\n3 Jaisalmer\n4 Jodhpur\n")
# input_city = int(input("Enter city: "))

# input_budget = float(input("Enter your budget: "))
# input_days = int(input("Enter number of days: "))

# print('''1 Spa  2 Parking included  3 Laundry   4 Pet friendly  5 Hot Tub
# 6 Pool  7 Restaurant    8 Business services    9 Free airport shuttle 
# 10 24/7 front desk 11 Babysitting  12 Gym  13 Kitchen  14 Bar  15 Parking available
# 16 Outdoor Space    17 Barbecue grill   18 Fireplace''')
# input_amenities = []
# input_amenities = input("Enter 5 amenities : ").split()
# print()


def hotelRec(input_city, input_budget, input_days, input_amenities):
